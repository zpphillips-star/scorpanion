  ...
  return (
    <div className="space-y-2 mx-3 mt-3">
      {leagues.map(league => {
        ...
        const next = getApproxNextSeason(league)
        return (
          <div key={league} className="flex items-center gap-3 px-4 py-3 rounded-2xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.16)" }}>
...
function DateStrip({
  ...
  return (
    <div ref={stripRef} className="overflow-x-auto no-scrollbar px-3 pb-2 pt-0.5 border-t border-zinc-500/65">
...
function ScheduleRow({ game, onTap }: { game: Game; onTap: () => void }) {
  ...
  return (
    <div
      className="flex items-center px-4 py-3 border-b border-zinc-500/60 hover:bg-zinc-800/20 active:bg-zinc-800/30 transition-colors cursor-pointer select-none"
                ...
                {(golfByDate.get(dateStr) ?? []).map(({ tournament, label, accentColor }) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center px-4 py-3 border-b border-zinc-500/50 hover:bg-zinc-800/20 active:bg-zinc-800/30 transition-colors cursor-pointer select-none gap-3"
