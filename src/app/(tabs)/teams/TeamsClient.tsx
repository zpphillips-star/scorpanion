    ...
    return (
      <button
        ...
        style={{
          ...
          border: `2px solid ${selected ? '#D95C17' : 'rgba(255,255,255,0.16)'}`,
            ...
            {stateTeams.map(team => {
              ...
              return (
                <button
                  ...
                  style={{
                    width: 76,
                    background: isFollowed ? 'rgba(217,92,23,0.15)' : 'rgba(255,255,255,0.15)',
  ...
  const UniversityCard = ({ config }: { config: DrillDownConfig }) => {
    ...
    return (
      <button
        ...
        style={{
          borderColor: followedCount > 0 ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.16)',
          backgroundColor: followedCount > 0 ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.03)',
        }}
      >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: `1.5px solid ${active ? '#D95C17' : 'rgba(255,255,255,0.16)'}`,
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: `2px solid ${isSelected ? '#D95C17' : 'rgba(255,255,255,0.15)'}`,
