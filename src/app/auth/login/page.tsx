    ...
    >
      <div className="w-full max-w-[400px]">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 60% 40% at 50% 0%, rgba(0,212,255,0.08) 0%, transparent 100%)',
          }}
        >
          ...
          <p style={{ color: '#9090b0', fontSize: '15px', fontWeight: 400 }}>
            Your teams. Every score.
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <label
              ...
              style={{ color: '#9090b0', fontSize: '13px', fontWeight: 500 }}
            >
              Email
            </label>
            <input
        ...
        <div className="mt-6 text-center space-y-3">
          <div>
            <Link
              ...
              style={{ color: '#9090b0', fontSize: '13px' }}
            >
              Forgot password?
            </Link>
          </div>
          <div style={{ color: '#9090b0', fontSize: '13px' }}>
            ...
            <Link href="/auth/signup" className="transition-colors" style={{ color: '#00d4ff' }}>
              Create an account
            </Link>
          </div>
          <div className="pt-1">
