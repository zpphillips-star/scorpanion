                    ...
                    {stageItems.length === 0 ? (
                      ...
                      stageItems.map(item => (
                        <div key={item.id} className="rounded-xl p-3.5 mt-2.5"
                          style={{ background: 'rgba(12,27,49,0.6)', border: '1px solid rgba(255,255,255,0.16)' }}>
                          ...
                          {user && (
                            <div className="mt-2.5 pt-2.5" style={{ borderTop: '1px solid rgba(255,255,255,0.15)' }}>
                              <select value={item.status} onChange={e => handleStatusChange(item.id, e.target.value as FeedbackStatus)}
                                ...
                                style={{ background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.1)', color: '#a1a1aa', padding: '6px 10px', cursor: 'pointer' }}>
