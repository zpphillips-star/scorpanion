        ...
        <table className="w-full min-w-max" style={{ borderCollapse: "separate", borderSpacing: 0 }}>
          ...
          <tbody>
            {linescores.map((team) => {
              ...
              return (
                <tr key={team.teamId} className="border-t border-zinc-600/55">
      ...
      {topScorers.length > 0 && (
        <>
          ...
          <div className="pb-2">
            ...
            <div className="flex items-center pb-1.5 mb-1 border-b border-zinc-600/55">
  ...
  return (
    <>
      ...
      {sharedStats.map(key => {
          ...
          return (
            <div key={key} className="px-5 py-5 border-b border-zinc-600/50 last:border-0">
              ...
              <div className="h-[3px] overflow-hidden flex" style={{ background: "rgba(255,255,255,0.11)" }}>
