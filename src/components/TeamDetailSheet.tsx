    ...
    <>
      ...
      >
        ...
        {data && !loading && data.recentForm.length > 0 && (
          <div className="px-4 pt-5 pb-4 border-t border-white/[0.09]">
              ...
              {[...data.recentForm].reverse().slice(0, 3).map((g, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Home row */}
                    <div className="flex items-center px-2.5 pb-2 pt-1 gap-1.5 border-t border-white/[0.09]">
                      {homeLogo
                    ...
                    {/* Footer */}
                    <div className="flex items-center justify-between px-2.5 py-1 border-t border-white/[0.09]" style={{ background: "rgba(0,0,0,0.25)" }}>
        ...
        {data && !loading && data.divisionStandings.length > 0 && (
          <div className="px-4 pt-5 pb-5 border-t border-white/[0.09]">
            <div className="flex items-center gap-2 mb-3">
        ...
        {/* Venue */}
        {data?.venue && (
          <div className="px-5 pb-5 border-t border-white/[0.09] pt-3">
